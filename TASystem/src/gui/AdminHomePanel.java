...
/**
 * Admin home panel with left navigation bar and right content area using CardLayout.
 */
public class AdminHomePanel extends JPanel {
    ...
    private String[] menuNames = {"Dashboard", "Review Jobs", "Users", "Workload"};
    private String[] menuCards = {"DASHBOARD", "REVIEW_JOBS", "USERS", "WORKLOAD"};
    ...
    public AdminHomePanel(MainFrame mainFrame) {
        ...
        contentPanel.add(new AdminDashboardPanel(mainFrame), "DASHBOARD");
        contentPanel.add(new AdminReviewJobsPanel(mainFrame), "REVIEW_JOBS");
        contentPanel.add(new AdminUsersPanel(mainFrame), "USERS");
        contentPanel.add(new AdminWorkloadPanel(mainFrame), "WORKLOAD");
