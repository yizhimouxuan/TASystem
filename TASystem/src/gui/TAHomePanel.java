...
/**
 * TA home panel with left navigation bar and right content area using CardLayout.
 */
public class TAHomePanel extends JPanel {
    ...
    // Menu item labels for highlighting
    private JLabel[] menuLabels;
    private String[] menuNames = {"Dashboard", "My Profile", "My CV", "Search Jobs", "My Applications"};
    private String[] menuCards = {"DASHBOARD", "PROFILE", "CV", "SEARCH", "APPLICATIONS"};

    public TAHomePanel(MainFrame mainFrame) {
        ...
        String name = (user != null) ? user.getName() : "TA";
        ...
        contentPanel.add(new TADashboardPanel(mainFrame), "DASHBOARD");
        contentPanel.add(new TAProfilePanel(mainFrame), "PROFILE");
        contentPanel.add(new TAUploadCVPanel(mainFrame), "CV");
        contentPanel.add(new TASearchJobPanel(mainFrame), "SEARCH");
        contentPanel.add(new TAApplicationPanel(mainFrame), "APPLICATIONS");
